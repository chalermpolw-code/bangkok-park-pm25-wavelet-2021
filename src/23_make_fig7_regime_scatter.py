...
COH_SUMMARY = PROJECT_ROOT / "analysis" / "outputs" / "wavelet_2021" / "coherence_summary.csv"
...
ELLIPSE_STYLE = {
    "Strong decoupler": dict(xy=(-14.3, 0.39), width=3.8, height=0.08, angle=0),
    "Broadband damper": dict(xy=(-6.75, 0.423), width=1.25, height=0.05, angle=0),
    "Weak follower": dict(xy=(-2.25, 0.515), width=3.0, height=0.08, angle=0),
}

# Manual label offsets and alignments: (dx, dy, horizontalalignment, verticalalignment)
LABEL_OFFSETS = {
    "Nong Chok Park": (0, 0.007, "center", "bottom"),
    "Suan Luang Rama IX Park": (0, -0.007, "center", "top"),
    "Chatuchak Park": (0.6, 0.015, "left", "center"),
    "Wachirabenchathat Park": (0.6, 0.00, "left", "center"),
    "Queen Sirikit Park": (0.6, -0.015, "left", "center"),
    "Phra Nakhon Park": (0, 0.007, "center", "bottom"),
    "Lumpini Park": (0, -0.007, "center", "top"),
    "Seri Thai Park": (0.15, 0.0, "left", "center"),
}
